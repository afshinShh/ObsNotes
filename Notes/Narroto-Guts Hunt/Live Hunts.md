...
# experian (guts course)
-  ATO 
	- we observed `successRedirectUrL` parameter set in local storage
	- [ ] _Flow:_ Open link + redirectUrl -> setSessionStorage -> check login -> deSessionStorage -> redirect (XSS)
