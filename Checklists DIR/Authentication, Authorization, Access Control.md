...
## Brute Force protection | acount locking |  Lock Out | rate limits
  ...
  - [ ] <mark style="background: #ADCCFFA6;">include your own login credentials</mark> at regular intervals throughout the wordlist. [[Notes/OLD Notes/WEB/vulnerabilities/Authentication vulnerabilities/payload#IP block|example]] 
